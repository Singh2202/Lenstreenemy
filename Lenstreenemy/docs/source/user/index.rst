...
The simplest way to install Lenstreenemy is using Pip.

.. code-block:: console

    $ pip install Lenstreenemy

This will install ``Lenstreenemy`` and all of its dependencies.
...
Report bugs at the `issue tracker <https://github.com/Singh2202/Lenstreenemy/issues>`_.
